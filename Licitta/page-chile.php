...
<section class="banner">
    <img class="w-100"
        src="<?= get_template_directory_uri(); ?>/assets/img/banners/fundo-intercambio-na-chile-ok-intercambio.webp" />
...
<div class="container py-5" id="sobre">
    <div class="row">
        <div class="col-sm-12 col-md-6">
            ...
            <p>O Chile é um país de território comprido e estreito que se estende pelo extremo oeste da América do Sul, com mais de 6.000 km de litoral ao longo do Oceano Pacífico. Santiago, sua capital, fica localizada em um vale cercado pelos Andes e pelas montanhas da Cordilheira da Costa do Pacífico Sul. Nessa cidade, a Plaza de Armas, repleta de palmeiras, abriga a catedral neoclássica e o Museu de História Nacional.</p>
        </div>
        <div class="col-sm-12 col-md-6">
            <h2 class="text-center mb-3">Vistos</h2>
            <p>Para visitar ou estudar o Chile não será necessário ter um visto. Pelo acordo do Mercosul, brasileiros podem ingressar no país com RG ou passaporte, desde que estejam dentro do prazo de validade. Quem ficará por um período superior no país, porém, devem solicitar permissão de residência. O custo benefício vem sendo um dos critérios que levam os brasileiros a decidir pelo Chile, um país muito receptivo aos cidadãos brasileiros.</p>
        </div>
    </div>
</div>
            ...
            <div class="col-4">
                <div class="container d-flex flex-column flex-lg-row align-items-center">
                    ...
                    <div class="text-lg-start text-center">
                        ...
                        <p class="text-white px-4 fw-light"> Santiago</p>
                    </div>
                </div>
            </div>
            <div class="col-4">
                <div class="container d-flex flex-column flex-lg-row align-items-center">
                    ...
                    <div class="text-lg-start text-center">
                        ...
                        <p class="text-white px-4 fw-light"> 756.950 km²</p>
                    </div>
                </div>
            </div>
            <div class="col-4">
            ...
            <div class="col-4">
                <div class="container d-flex flex-column flex-lg-row align-items-center">
                    ...
                    <div class="text-lg-start text-center">
                        ...
                        <p class="text-white px-4 fw-light"> Peso Chileno</p>
                    </div>
                </div>
            </div>
            <div class="col-4">
            ...
            <div class="swiper-wrapper pt-5">
                    ...
                    <div class="post-frame d-flex justify-content-center pt-3">
                        <a class="card border-0 shadow position-relative">
                            <img class="rounded-3" style="height: 20em;"
                                src="<?= get_template_directory_uri(); ?>/assets/img/cidades/chile/cidade-santiago-chile-ok-intercambio.webp"
                                alt="Cidade Santiago chile ok intercambio" />
                            <h3
                ...
                <div class="swiper-slide">
                    <div class="post-frame d-flex justify-content-center pt-3">
                        <a class="card border-0 shadow position-relative">
                            <img class="rounded-3" style="height: 20em;"
                                src="<?= get_template_directory_uri(); ?>/assets/img/cidades/chile/cidade-valparaiso-chile-ok-intercambio.webp"
                                alt="Cidade Valparaiso chile ok intercambio" />
                            <h3
                                class="card-text-background position-absolute bottom-0 w-100 rounded-3 py-2 px-2 mb-0 text-center cl-white">
                                Valparaiso
                            </h3>
