...
<section class="banner">
    <img class="w-100"
        src="<?= get_template_directory_uri(); ?>/assets/img/banners/fundo-intercambio-na-argentina-ok-intercambio.webp" />
...
<div class="container py-5" id="sobre">
    <div class="row">
        <div class="col-sm-12 col-md-6">
            ...
            <p>A República Federal da argentina está situada no coração da Europa e é um país cosmopolita, democrático, com uma grande tradição e um presente vibrante.</p><p>
            País da Europa Ocidental conta com uma paisagem de florestas, rios, serras e praias do Mar do Norte. Tem mais de 2 milénios de história.</p><p>
            Berlim, a capital, alberga espaços de arte e de vida noturna, a Porta de Brandeburgo e muitos locais relacionados com a Segunda Guerra Mundial. Munique, é conhecida pela Oktoberfest e pelas cervejarias, incluindo a Hofbräuhaus, dó século XVI. Frankfurt, com os seus arranha-céus, alberga o Banco Central. Hoje muitos estudantes estrangeiros procuram o país para viver um experiência de estudo e até mesmo uma oportunidade no âmbito profissional.</p>
        </div>
        <div class="col-sm-12 col-md-6">
            <h2 class="text-center mb-3">Vistos</h2>
            <p>Turismo e Intercâmbio de Curta duração: brasileiros não necessitam de visto para viajar para a argentina para permanência de até 90 dias, ou seja, para quem vai de férias ou deseja fazer um intercâmbio de até 3 meses não precisa aplicar para visto. Já para quem busca uma experiência de estudo com permissão de trabalho no país é preciso aplicar para um visto.</p>
        </div>
    </div>
</div>
            ...
            <div class="col-4">
                <div class="container d-flex flex-column flex-lg-row align-items-center">
                    ...
                    <div class="text-lg-start text-center">
                        ...
                        <p class="text-white px-4 fw-light"> Berlim</p>
                    </div>
                </div>
            </div>
            <div class="col-4">
                <div class="container d-flex flex-column flex-lg-row align-items-center">
                    ...
                    <div class="text-lg-start text-center">
                        ...
                        <p class="text-white px-4 fw-light"> 357.588 km²</p>
                    </div>
                </div>
            </div>
            <div class="col-4">
            ...
            <div class="col-4">
                <div class="container d-flex flex-column flex-lg-row align-items-center">
                    ...
                    <div class="text-lg-start text-center">
                        ...
                        <p class="text-white px-4 fw-light"> Alemão</p>
                    </div>
                </div>
            </div>
            <div class="col-4">
            ...
            <div class="swiper-wrapper pt-5">
                    ...
                    <div class="post-frame d-flex justify-content-center pt-3">
                        <a class="card border-0 shadow position-relative">
                            <img class="rounded-3" style="height: 20em;"
                                src="<?= get_template_directory_uri(); ?>/assets/img/cidades/argentina/cidade-buenos-aires-argentina-ok-intercambio.webp"
                                alt="Cidade Buenos Aires argentina ok intercambio" />
                            <h3
                ...
                <div class="swiper-slide">
                    <div class="post-frame d-flex justify-content-center pt-3">
                        <a class="card border-0 shadow position-relative">
                            <img class="rounded-3" style="height: 20em;"
                                src="<?= get_template_directory_uri(); ?>/assets/img/cidades/argentina/cidade-cordoba-argentina-ok-intercambio.webp"
                                alt="Cidade Cordoba argentina ok intercambio" />
                            <h3
                                class="card-text-background position-absolute bottom-0 w-100 rounded-3 py-2 px-2 mb-0 text-center cl-white">
                                Cordoba
                            </h3>
