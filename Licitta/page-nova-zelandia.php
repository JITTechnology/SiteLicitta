...
<section class="banner">
    <img class="w-100"
        src="<?= get_template_directory_uri(); ?>/assets/img/banners/fundo-intercambio-na-nova-zelandia-ok-intercambio.webp" />
...
<div class="container py-5" id="sobre">
    <div class="row">
        <div class="col-sm-12 col-md-6">
            ...
            <p>O país está localizado na Oceania, assim como a Austrália, e também possui um clima agradável: temperado,
                com longos dias de sol no verão. O idioma falado é o inglês e o maori. Os Kiwis, como são chamados os
                neozelandeses, são amáveis, educados e você não se arrependerá de expandir conhecimentos e conhecer uma
                nova cultura neste intercâmbio.</p>
            <p>

                A Nova Zelândia é o país que incentiva o intercâmbio e o emprego aos imigrantes de diversas partes do
                mundo, isso não só movimenta a economia como, também, fomenta a globalização e a multiculturalização.
            </p>
        </div>
        <div class="col-sm-12 col-md-6">
            <h2 class="text-center mb-3"> Estudar e trabalhar</h2>
            <p>Brasileiros que pretende estudar ou visitar o país por até 3 meses precisam do NZeTA, custa NZ$47,00 e
                leva 1 dia para ser emitido.
                Para visto de Estudo e Trabalho, a nova regra facilita mais a estadia dos intercambistas na Nova
                Zelândia.</p>
            <p>

                Os alunos matriculados em cursos com duração de 14 semanas terão o direito de trabalhar na Nova Zelândia
                por até 20 horas semanais. Já os estudantes matriculados em cursos com duração superior a 12 meses
                poderão trabalhar em período integral durante as férias.</p>
        </div>
    </div>
</div>
            ...
            <div class="col-4">
                <div class="container d-flex flex-column flex-lg-row align-items-center">
                    ...
                    <div class="text-lg-start text-center">
                        ...
                        <p class="text-white px-4 fw-light"> Wellington</p>
                    </div>
                </div>
            </div>
            <div class="col-4">
                <div class="container d-flex flex-column flex-lg-row align-items-center">
                    ...
                    <div class="text-lg-start text-center">
                        ...
                        <p class="text-white px-4 fw-light"> 268.021 km²</p>
                    </div>
                </div>
            </div>
            <div class="col-4">
                <div class="container d-flex flex-column flex-lg-row align-items-center">
                    ...
                    <div class="text-lg-start text-center">
                        ...
                        <p class="text-white px-4 fw-light"> 230/240 V</p>
                    </div>
                </div>
            </div>
            <div class="col-4">
                <div class="container d-flex flex-column flex-lg-row align-items-center">
                    ...
                    <div class="text-lg-start text-center">
                        ...
                        <p class="text-white px-4 fw-light"> Inglês, Maori e Língua de Sinais Neozelandesa</p>
                    </div>
                </div>
            </div>
            <div class="col-4">
                <div class="container d-flex flex-column flex-lg-row align-items-center">
                    ...
                    <div class="text-lg-start text-center">
                        ...
                        <p class="text-white px-4 fw-light"> Dólar Neozelandês</p>
                    </div>
                </div>
            </div>
            <div class="col-4">
                <div class="container d-flex flex-column flex-lg-row align-items-center">
                    ...
                    <div class="text-lg-start text-center">
                        ...
                        <p class="text-white px-4 fw-light"> GMT +12</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="swiper-wrapper pt-5">
                    ...
                    <div class="post-frame d-flex justify-content-center pt-3">
                        <a class="card border-0 shadow position-relative">
                            <img class="rounded-3" style="height: 20em;"
                                src="<?= get_template_directory_uri(); ?>/assets/img/cidades/nova-zelandia/cidade-auckland-nova-zelandia-ok-intercambio.webp"
                                alt="Cidade Auckland nova-zelandia ok intercambio" />
                            <h3
                ...
                <div class="swiper-slide">
                    <div class="post-frame d-flex justify-content-center pt-3">
                        <a class="card border-0 shadow position-relative">
                            <img class="rounded-3" style="height: 20em;"
                                src="<?= get_template_directory_uri(); ?>/assets/img/cidades/nova-zelandia/cidade-otago-nova-zelandia-ok-intercambio.webp"
                                alt="Cidade Otago nova-zelandia ok intercambio" />
                            <h3
                                class="card-text-background position-absolute bottom-0 w-100 rounded-3 py-2 px-2 mb-0 text-center cl-white">
                                Otago
                            </h3>
                ...
                <div class="swiper-slide">
                    <div class="post-frame d-flex justify-content-center pt-3">
                        <a class="card border-0 shadow position-relative">
                            <img class="rounded-3" style="height: 20em;"
                                src="<?= get_template_directory_uri(); ?>/assets/img/cidades/nova-zelandia/cidade-queensland-nova-zelandia-ok-intercambio.webp"
                                alt="Cidade Queensland nova-zelandia ok intercambio" />
                            <h3
                                class="card-text-background position-absolute bottom-0 w-100 rounded-3 py-2 px-2 mb-0 text-center cl-white">
                                Queensland
                            </h3>
                ...
                <div class="swiper-slide">
                    <div class="post-frame d-flex justify-content-center pt-3">
                        <a class="card border-0 shadow position-relative">
                            <img class="rounded-3" style="height: 20em;"
                                src="<?= get_template_directory_uri(); ?>/assets/img/cidades/nova-zelandia/cidade-queenstown-nova-zelandia-ok-intercambio.webp"
                                alt="Cidade Queenstown nova-zelandia ok intercambio" />
                            <h3
                                class="card-text-background position-absolute bottom-0 w-100 rounded-3 py-2 px-2 mb-0 text-center cl-white">
                                Queenstown
                            </h3>
...
<section class="bg-purple">
    <div class="container py-5">
        ...
        <div class="container-youtube">
            <iframe class="w-100 youtube"  height="400" src="https://www.youtube.com/embed/VO2JgToIi0s?controls=0"
